...
const PostItem = ({ item, token, currentUserId }) => {
  ...
  const handleLike = async () => {
    ...
    try {
      await axios.put(
        `https://social-media-platform-bice.vercel.app/api/social/like/${item._id}`,
        {},
        {
  ...
  const profilePic = author.profilePic
    ? author.profilePic.startsWith("http")
      ? author.profilePic
      : `https://social-media-platform-bice.vercel.app/${author.profilePic}`
    ...
    <View style={styles.card}>
      ...
      <Image
        source={{
          uri: item.image.startsWith("http")
            ? item.image
            : `https://social-media-platform-bice.vercel.app/${item.image}`,
        }}
      ...
      <View style={styles.actions}>
        <View style={styles.row}>
          ...
          {/* Yahan Navigation add ho gayi hai */}
          <TouchableOpacity 
            onPress={() => navigation.navigate('Comments', { postId: item._id, token, currentUserId })} 
            style={styles.icon}
          >
